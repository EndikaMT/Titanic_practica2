...
- Age. Aunque sí aparecen valores extremos, son totalmente correctos, ya que el maximo, como hemos visto previamente es `r max(titanic2$Age)` años.
...
* Podemos constatar que mujeres y niños tuvieron un índice de superviviencia más alto que el de varones adultos. Esto se puede observar mediante el contraste de hipótesis realizado al igual que comprobando la media de la variable Survived para ambos grupos.
